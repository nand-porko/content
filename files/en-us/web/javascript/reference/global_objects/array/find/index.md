...
**Warning:** Concurrent modification of the kind described above can frequently lead to hard-to-understand code and is generally to be avoided (except in special cases).
